...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'color': '#503D36', 'textAlign': 'center'}),#May include style for title
    html.Div([#TASK 2.2: Add two dropdown menus
        html.Label("Select Statistics:"),
        dcc.Dropdown(
            id='dropdown-statistics',
            options= dropdown_options,
            value='Select Satistics',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unp_data= recession_data.groupby(['Vehicle_Type','Unemployment_Rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(unp_data,
            x = 'Unemployment_Rate',
            y = 'Automobile_Sales',
            color = 'Vehicle_Type',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        x = 'Month',
        y = 'Automobile_Sales',
        title = 'Total Monthly Autmoboile Sales'))
